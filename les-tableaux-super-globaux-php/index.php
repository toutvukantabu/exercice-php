 ...
 *****************************************/
 ...
 if(!empty($_POST))
 {
   ...
   {
     $message = '<p>Veuillez indiquer votre login svp !</p>';
   }
     // Le mot de passe est-il rempli ?
     elseif(empty($_POST['motDePasse']))
   {
     $message = '<p>Veuillez indiquer votre mot de passe svp !</p>';
   }
     // Le login est-il correct ?
     elseif($_POST['login'] !== LOGIN)
   {
     $message = '<p>Votre login est faux !</p>';
   }
     // Le mot de passe est-il correct ?
     elseif($_POST['motDePasse'] !== PASSWORD)
   {
     $message = '<p>Votre mot de passe est faux !</p>';
   }
     else
   {
     // L'identification a réussi
     $message = '<p>Bienvenue</p> '. LOGIN .' !';
   }
 }?>
